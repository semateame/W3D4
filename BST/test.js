...
describe("BinarySearchTree", function () {
    ...
    describe("insertAllarray() method", function () {
        it("inserts the array element to the bst", function () {
           let arr=[2,9] 
           bst.insertAll(arr)
            assert.equal(bst.root.left.left.right.value, 2);
        });
    });
    
    describe("readintoarray() method", function () {
        
        it("returns the array of values in the bst", function () {
            let arr=[];
           arr.push(bst.readIntoArray());
